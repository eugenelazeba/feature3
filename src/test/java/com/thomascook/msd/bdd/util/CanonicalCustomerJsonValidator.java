...
/**
 * Created by Sergii Meleshko
 * e-mail: sergey.meleshko@thomascookonline.com
 */
public class CanonicalCustomerJsonValidator {
    private final JsonSchema jsonSchema;

    public CanonicalCustomerJsonValidator(ResourceLoader resourceLoader, String jsonSchemaPath) throws IOException, ProcessingException {
